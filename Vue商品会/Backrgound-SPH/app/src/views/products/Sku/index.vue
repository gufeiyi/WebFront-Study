<template>
  <div>
    <!-- 表格 -->
    <el-table style="width: 100%;margin-top: 50px;" border :data="records">
    ...
    <!-- 分页器 -->
    <el-pagination style="text-align: center;margin-top: 20px;" :current-page="page" :page-sizes="[3, 5, 10]"
      :page-size="limit" layout="prev,pager,next,jumper,->,sizes,total" :total="total" @current-change="getSkuList"
...
export default {
  ...
  methods: {
    async getSkuList(pages = 1) {
      ...
      let result = await this.$API.sku.reqTotalSkuList(page, limit);
      if (result.code == 200) {
